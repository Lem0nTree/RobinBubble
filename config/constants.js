...
module.exports = {
  // Bot messages
  messages: {
    welcome: "👋 Welcome to RobinBubble!\n\nI can help you check token information and visualize ownership distribution through bubble maps on Base chain. Just send me a Base token contract address to get started.",
    help: "🔍 *RobinBubble Help*\n\n" +
          ...
          "This bot works exclusively with tokens on Base chain.\n\n",
