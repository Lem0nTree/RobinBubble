...
### Token Analysis
- 🔍 One-click token lookup by pasting any RobinPump token contract address directly in chat
...
- ⚡ RobinPump tracker - optimized for analyzing tokens on RobinPump (Base chain)
...
Watch our demo video to see RobinBubble in action:

[![RobinBubble Demo](https://img.youtube.com/vi/2W5heXSih40/0.jpg)](https://www.youtube.com/watch?v=2W5heXSih40)

Click the image above to watch the demo on YouTube.

## 🔗 Supported Network

- **Base (BASE)** - Tracker for analyzing tokens on RobinPump on Base chain


## 🚀 Quick Start

1. **Find the Bot on Telegram**: [RobinBubble](https://t.me/robinbubble)
2. **Start a Chat**: Click "Start" to initiate the bot
3. **Check a Token**: Paste any RobinPump token contract address to get instant analysis
...
1. **Direct Contract Input**: Paste any RobinPump token contract address directly in the chat
...
Adding RobinBubble to your community enhances your group's capabilities for analyzing RobinPump tokens on Base chain.
...
- **Automatic Token Analysis**: Members can paste any RobinPump token contract address for instant analysis
- **RobinPump Tracker**: Optimized for tracking and analyzing tokens on RobinPump (Base chain)
